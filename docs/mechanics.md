...
{% include "tables.md" start="<!-- begin:cyberware-density-table -->" end="<!-- end:cyberware-density-table -->" %}
...
{% include "tables.md" start="<!-- begin:immunoblockers-table -->" end="<!-- end:immunoblockers-table -->" %}
